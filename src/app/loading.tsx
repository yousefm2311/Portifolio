  ...
  return (
    <div className="min-h-screen">
      <main className="mx-auto max-w-6xl px-4 pb-16">
        <section className="pt-6 sm:pt-10 space-y-4">
        ...
        <section className="mt-8 space-y-6 pb-6">
          ...
          <div className="flex gap-3 overflow-hidden">
            {Array.from({ length: 8 }).map((_, index) => (
              <div key={index} className="h-8 w-28 rounded-full skeleton shimmer" />
            ))}
          </div>
        </section>
        ...
        <section className="mt-8 space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {Array.from({ length: 6 }).map((_, index) => (
              <div key={index} className="glass-soft rounded-2xl p-5">
                <div className="h-40 w-full rounded-2xl skeleton shimmer" />
                <div className="mt-4 h-4 w-3/4 rounded-full skeleton shimmer" />
                <div className="mt-2 h-4 w-1/2 rounded-full skeleton shimmer" />
                <div className="mt-4 h-9 w-28 rounded-full skeleton shimmer" />
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-12 space-y-4">
          <div className="h-6 w-56 rounded-full skeleton shimmer" />
        ...
        <section className="mt-12">
          <div className="glass-soft rounded-3xl p-6">
            <div className="h-6 w-56 rounded-full skeleton shimmer" />
            <div className="mt-4 h-4 w-full rounded-full skeleton shimmer" />
            <div className="mt-2 h-4 w-3/4 rounded-full skeleton shimmer" />
            <div className="mt-6 h-12 w-40 rounded-full skeleton shimmer" />
          </div>
        </section>
      </main>
    </div>
